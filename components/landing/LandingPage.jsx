...
export default function LandingPage() {
  ...
  // NOTE: deliberately no `if (loading)` early return here. Returning a spinner
  // while the client resolved the session meant the server-rendered homepage
  // contained a spinner instead of the marketing copy, so crawlers indexed
  // nothing. `user` is null until auth resolves, which renders the same
  // logged-out page the server renders.
