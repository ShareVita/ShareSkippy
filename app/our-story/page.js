      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="bg-white rounded-2xl shadow-lg p-8 md:p-12 mb-8">
          ...
          <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
            <p>
              Hi, I'm Kaia, the founder of ShareSkippy — a free, community-driven way to connect dog
              owners with dog lovers for walks, hikes, cuddles, and adventures.
            </p>
            <p>
              The idea came from a simple act of kindness. A close friend of mine was very sick and
              couldn't take his dog out for more than a few quick bathroom breaks. I posted on a
              local Oakland Facebook group asking if anyone could help. Within hours, over 40 people
              replied. Total strangers. All offering to walk a dog they'd never met.
            </p>
            <p>
        ...
        <section className="bg-white rounded-2xl shadow-lg p-8 md:p-12 mb-8">
          ...
          <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
            <p>
              I didn't want to build "the next Rover" or "another app." I wanted to create a space
              that feels neighborly — where people help each other because they care, not because
              they're being paid.
            </p>
            <p>
              There are already plenty of platforms that make dog care transactional. ShareSkippy is
              about connection over commerce. It's for the busy dog owner who needs help during the
              day, the college student who misses their dog back home, the retiree who just wants
              some furry company on walks, and everyone in between.
            </p>
        ...
        <section className="bg-white rounded-2xl shadow-lg p-8 md:p-12 mb-8">
          ...
          <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
            <p>
              We'd like to grow and expand! To do so, I'm looking for donations (501(c)(3) pending)
              and more volunteers and interns to help out.
            </p>
            <p>
