...
export const testimonials = [
  {
    ...
    name: 'Sarah',
    text: 'Dog Lover',
    testimonial: 'I cant have a dog in my apartment, but now I hike with Max every week.',
    dog: dog4,
  },
  {
    id: 2,
  ...
  },
  {
    id: 4,
    name: 'David',
    text: 'Recovering Owner',
    testimonial: 'Recovering from surgery, my neighbors made sure Bella still got her daily walks.',
    dog: dog5,
  },
  {
    id: 5,
